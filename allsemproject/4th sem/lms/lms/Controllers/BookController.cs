...
namespace lms.Controllers
{
    public class BookController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,bname,cat_id,auth_id,p_id,contents,pages,edition")] book book)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,bname,cat_id,auth_id,p_id,contents,pages,edition")] book book)
        {
            if (ModelState.IsValid)
            {
